...
<div class="container mt-4">
    ...
    <div class="card p-4">
        ...
        <form action="{{ isset($karyawan) ? route('karyawan_update', $karyawan->id_karyawan) : route('store_karyawan') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if(isset($karyawan))
                @method('PUT')
            @endif
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="nama_lengkap" class="form-control" placeholder="Nama lengkap"
                           value="{{ old('nama_lengkap', isset($karyawan) ? $karyawan->nama_karyawan : '') }}" required>
                    @error('nama_karyawan')
...
<script>
    ...
    // Tambahkan di form karyawan
$(document).ready(function() {
    // Validasi input numeric untuk gaji, tunjangan, insentif
    $('.numeric-input').on('input', function() {
        let value = $(this).val();
        let maxValue = 2147483647; // INT max value
        ...
        if (value > maxValue) {
            ...
            Swal.fire({
                ...
                text: 'Nilai maksimal adalah Rp 2.147.483.647',
                timer: 3000,
